...
final class ViewController: UIViewController {
    ...
    private var outImage: UIImageView = {
        let img = UIImageView()
        img.tintColor = UIColor.white
        
        let customImage = #imageLiteral(resourceName: "Image 1")
        let newWidth = 35
        let newHeight = 40
...
//        let customImage = #imageLiteral(resourceName: "Image")
...
//        img.image = newImage
    ...
    func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            // passwordInfoLabel.centerYAnchor.constraint(equalTo: passwordTextFieldView),
            ...
            outImage.topAnchor.constraint(equalTo: view.safeAreaLayoutGuide.topAnchor, constant: 15),
            outImage.leadingAnchor.constraint(equalTo: view.leadingAnchor, constant: 20),
            
            LogoImage.topAnchor.constraint(equalTo: view.topAnchor, constant: 22),
            LogoImage.leadingAnchor.constraint(equalTo: outImage.leadingAnchor, constant: 10)
    ...
    @objc func passwordSecureModeSetting() {
        if passwordSecureButton.titleLabel!.text == "표시" {
